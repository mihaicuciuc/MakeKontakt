...
private:
    ...
    int deltas_valid;
    /*
    int baseline_u, baseline_d, baseline_l, baseline_r;
    int sample_arr_u[10], sample_arr_d[10], sample_arr_l[10], sample_arr_r[10];
    int sample_arr_idx_u, sample_arr_idx_d, sample_arr_idx_l, sample_arr_idx_r;
    */
};
