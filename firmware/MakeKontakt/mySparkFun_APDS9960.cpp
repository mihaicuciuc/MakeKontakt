...
int SparkFun_APDS9960::readGesture()
{
    ...
    while(1) {
        ...
        if( (gstatus & APDS9960_GVALID) == APDS9960_GVALID ) {
            ...
            ud_delta = gesture_ud_delta_;
            lr_delta = gesture_lr_delta_;
            deltas_valid = 1;
...
int SparkFun_APDS9960::getDeltasValid()
{
  return deltas_valid;
}

int SparkFun_APDS9960::getUDdelta()
{
  return ud_delta;
}

int SparkFun_APDS9960::getLRdelta()
{
  return lr_delta;
}

void SparkFun_APDS9960::resetDeltas()
{
  ud_delta = 0;
  lr_delta = 0;
  deltas_valid = 0;
